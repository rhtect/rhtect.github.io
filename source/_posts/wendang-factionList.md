...
### 概述
* 辅助运输系统可以深入开发的功能较多
* 辅助运输系统向产品化转型，逐步完善功能的可配置性
* 开发工程师资源短缺
* 功能开发逐渐进入`深水区`，对工程师要求提高
* 功能开发尽量减少定制化的比重
* 辅助运输的开发目标：`智能化加人工干预`
...
### 功能优先级排序
* 1.大型车辆避让提醒（<font color="red">4月24日</font> ）
* 2.里程统计相关功能（<font color="red">4月24日</font> ）
* 3.魏墙矿视频监控信息接入（<font color="red">4月30日</font> ）
* 4.违章管理系统 （<font color="red">5月20日 第一版</font> ）
> * 障碍物预警
> * 应急广播功能（利用消息推送播放本地语音的方式实现）
> * 违章提醒功能
* 5.交通指挥系统 （<font color="red">5月29日 第一版</font> ）
> * 定时控制红绿灯切换
> * 程序控制红绿灯切换
> * 绿灯闪烁代替黄灯
> * 人工控制红绿灯状态
> * 基于精准定位 距离 时速智能判定
* 6.领导终端APP软件（<font color="red">5月29日 第一版</font> ）
> * 完成`调度员`角色的开发设计
> * 完成页面的展示与交互
* 7.数据分析统计报表
* 8.滴滴模式智能派车 
...
### 车载智能终端系统 （<font color="orange">测试阶段</font>）
...
### 滴滴模式智能派车 
#### 开发进度 （<font color="red">待定</font>）
* 需求调研（<font color="red">待定</font>）
* 产品设计（<font color="red">待定</font>）
* UI设计 （<font color="red">待定</font>）
* 功能开发 （<font color="red">待定</font>）
* 产品测试（<font color="red">待定</font>）

#### 功能列表
| 功能              | 是否完成 | 备注           |
|-----------------|------|--------------|
| <font color="red">用车申请资源化</font>           | <font color="red">否</font>     | 计划开发 |
| <font color="red">用车申请智能审核</font>          | <font color="red">否</font>     | 计划开发 |
| <font color="red">用车申请智能提交</font>          | <font color="red">否</font>    | 计划开发 |
| <font color="red">用车申请智能指派</font>          | <font color="red">否</font>    | 计划开发 |
...
| 矿用本安型信号灯       | 完成   |           |
| 矿用隔爆兼本安型直流稳压电源 | 完成   |           |
| <font color="orange">定时控制红绿灯切换</font>       | <font color="orange">否</font>     | 正在测试 |
| <font color="orange">程序控制红绿灯切换</font>       | <font color="orange">否</font>     | 正在测试 |
| <font color="orange">绿灯闪烁代替黄灯</font>       | <font color="orange">否</font>     | 正在测试 |
| <font color="orange">人工控制红绿灯状态</font>       | <font color="orange">否</font>     | 正在开发 |
| <font color="red">基于精准定位 距离 时速智能判定</font>       | <font color="red">否</font>     | 计划开发 |
| <font color="red">闯红灯违章取证拍照</font>       | <font color="red">否</font>     | 计划开发，需要硬件支持 |
| <font color="red">全程测速违章提醒取证拍照</font>       | <font color="red">否</font>     | 计划开发 |
| <font color="red">违章播报功能</font>       | <font color="red">否</font>     | 计划开发，需要硬件支持 |
