...
2. 在估算、计划的过程中利用了哪些组织级的历史数据或历史资料？
	> `答`: 组织级度量数据，是公司经过几年的项目数据收集而形成的，代表公司能力的数据。估算、计划的过程中利用了资产库里存放的这些数据，含经验教训、度量、培训、最佳实践、风险等。
...
2. 同行评审活动的数据会进行分析吗？什么时机分析？从哪些维度分析？能举例说明某一次的分析结果和结论吗？目前项目的同行评审的效率和效果，您怎么看？
